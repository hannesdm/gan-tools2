...
def mnist_gan():
    return gan.WGAN_GP(discriminator=mnist_discriminator_model(), generator=mnist_generator_model())
...
if __name__ == '__main__':
    ...
    gan = mnist_gan()
    gan.train(X_train_mnist, steps=20000, batch_size=32, plot_interval=250, image_shape=(28, 28))
